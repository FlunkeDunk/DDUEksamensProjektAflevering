...
var superScalingAmount: float = 20
var hyperScalingAmount: float = 100
var superScalingStart: int = 10
var hyperScalingStart: int = 20

func whenBought() -> void:
	generatorMenu.multipliers += 1
...
func updateText() -> void:
	scaling = generatorMenu.multBase
	#description = "x" + str(generatorMenu.multBase) + " energy per second"
	super.updateText()
