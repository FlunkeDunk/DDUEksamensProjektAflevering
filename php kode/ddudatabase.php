...
# Set connection properties for our database:
	$sql_host = "mysql112.unoeuro.com";	# Where our database is located
	$sql_db = "ddu_gram_dk_db";			# Name of our database
	$sql_username = "ddu_gram_dk";		# Login username for our database
	$sql_password = "G9ezARgyfF3anDh2c4km";			# Login password for our database
	...
	switch ($_REQUEST['command']){
		...
		case "add_score":
			...
			# Make sure our username is under 12 characters:
			$username = $json['username'];
			if (strlen($username) > 12)
				$username = substr($username, 12);
			
			
			# Form our SQL request string:
			$template = "INSERT INTO `scores` (username, score) VALUES (:username, :score)";
		...
		case "get_scores":
			...
			$template = "SELECT * FROM `scores` ORDER BY score DESC LIMIT :number OFFSET :offset";
